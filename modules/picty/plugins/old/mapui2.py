...
try:
    ...
    if '__version__' in dir(osmgpsmap) and osmgpsmap.__version__>='0.4.0':
        ...
        map_source=(
        ('Maps for Free',osmgpsmap.MapSource_t.MAPS_FOR_FREE,'mapsforfree'),
        ('Open Street Map',osmgpsmap.MapSource_t.OPENSTREETMAP,'openstreetmap'),
        ('Open Street Map Renderer',osmgpsmap.MapSource_t.OPENSTREETMAP_RENDERER,'openstreetmaprenderer'),
        #('Virtual Earth Satellite',osmgpsmap.MapSource_t.VIRTUAL_EARTH_SATTELITE,'virtualearthsatellite'),
        ('Open Aerial Map',osmgpsmap.MapSource_t.OPENAERIALMAP,'openaerialmap'),
        ('Google Hybrid',osmgpsmap.MapSource_t.GOOGLE_HYBRID,'googlehybrid'),
        #('Google Satellite',osmgpsmap.MapSource_t.GOOGLE_SATTELITE,'googlesatellite'),
        )
except:
    map_source=tuple()
